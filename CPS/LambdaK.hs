...
calculate (S.Arith J.Add) (N_Lit (S.Int a)) (N_Lit (S.Int b))      = Annotated_V (N_Lit (S.Int (a + b))) (N_JClass "java.lang.Integer")
calculate (S.Arith J.Sub) (N_Lit (S.Int a)) (N_Lit (S.Int b))      = Annotated_V (N_Lit (S.Int (a - b))) (N_JClass "java.lang.Integer") 
calculate (S.Arith J.Mult) (N_Lit (S.Int a)) (N_Lit (S.Int b))     = Annotated_V (N_Lit (S.Int (a * b))) (N_JClass "java.lang.Integer") 
calculate (S.Arith J.Div) (N_Lit (S.Int a)) (N_Lit (S.Int b))      = Annotated_V (N_Lit (S.Int (a `div` b))) (N_JClass "java.lang.Integer") 
calculate (S.Arith J.Rem) (N_Lit (S.Int a)) (N_Lit (S.Int b))      = Annotated_V (N_Lit (S.Int (a `rem` b))) (N_JClass "java.lang.Integer")
calculate (S.Compare J.GThan) (N_Lit (S.Int a)) (N_Lit (S.Int b))  = Annotated_V (N_Lit (S.Bool (a > b))) (N_JClass "java.lang.Boolean")  
calculate (S.Compare J.GThanE) (N_Lit (S.Int a)) (N_Lit (S.Int b)) = Annotated_V (N_Lit (S.Bool (a >= b))) (N_JClass "java.lang.Boolean") 
calculate (S.Compare J.LThan) (N_Lit (S.Int a)) (N_Lit (S.Int b))  = Annotated_V (N_Lit (S.Bool (a < b))) (N_JClass "java.lang.Boolean") 
calculate (S.Compare J.LThanE) (N_Lit (S.Int a)) (N_Lit (S.Int b)) = Annotated_V (N_Lit (S.Bool (a <= b))) (N_JClass "java.lang.Boolean") 
calculate (S.Compare J.Equal) (N_Lit (S.Int a)) (N_Lit (S.Int b))  = Annotated_V (N_Lit (S.Bool (a == b))) (N_JClass "java.lang.Boolean")     
